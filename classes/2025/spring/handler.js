...
function renderSite(res) {
    ...
    $("#img1").attr("src", "../../../images/2024Headshots/fall/"+data["teacher1img"]+".jpg")
    ...
    if(data["teacher2"] != '') {
        ...
        $("#img2").attr("src", "../../../images/2024Headshots/fall/"+data["teacher2img"]+".jpg")
    }
    if(data["teacher3"] != '') {
        ...
        $("#img3").attr("src", "../../../images/2024Headshots/fall/"+data["teacher3img"]+".jpg")
    }
    if(data["teacher4"] != '') {
        ...
        $("#img4").attr("src", "../../../images/2024Headshots/fall/"+data["teacher4img"]+".jpg")
    }
    getExif()
}
$(document).ready(function() {
    ...
    $.ajax({
        ...
        // url : "http://localhost:3000/class2024fall?id="+id,
        url : "https://siliconvalleyyouth-current.herokuapp.com/class2024fall?id="+id,
        dataType: "json",
