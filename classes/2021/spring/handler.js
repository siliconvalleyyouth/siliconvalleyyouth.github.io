...
function renderSite(res) {
    ...
    if(data["teacher2"] != '') {
        ...
        $("#img2").attr("src", "../../../images/2021Headshots/Spring/"+data["teacher2img"]+".jpg")
    }
    if(data["teacher3"] != '') {
        ...
        $("#img3").attr("src", "../../../images/2021Headshots/Spring/"+data["teacher3img"]+".jpg")
    }
}
$(document).ready(function() {
    ...
    $.ajax({
        ...
        url : "https://siliconvalleyyouth.herokuapp.com/api/classes/2021/spring/"+id,
        dataType: "json",
