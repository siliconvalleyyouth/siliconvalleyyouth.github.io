...
function renderSite(res) {
    ...
    $("#img1").attr("src", "../../../images/2023Headshots/Spring/"+data["teacher1img"]+".jpg")
    ...
    linkProfileElement("#teacher2", data["teacher2"]);
        ...
        $("#img2").attr("src", "../../../images/2023Headshots/Spring/"+data["teacher2img"]+".jpg")
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        url : "https://siliconvalleyyouth.herokuapp.com/api/classes/2023/spring/"+id,
        dataType: "json",
