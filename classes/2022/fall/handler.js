...
function renderSite(res) {
    ...
    $("#img1").attr("src", "../../../images/2022Headshots/Fall/"+data["teacher1img"]+".jpg")
    ...
    if(data["teacher2"] != '') {
        ...
        $("#img2").attr("src", "../../../images/2022Headshots/Fall/"+data["teacher2img"]+".jpg")
    }
    if(data["teacher3"] != '') {
        ...
        $("#img3").attr("src", "../../../images/2022Headshots/Fall/"+data["teacher3img"]+".jpg")
    }
    getExif()
}
$(document).ready(function() {
    ...
    $.ajax({
        ...
        url : "https://siliconvalleyyouth-current.herokuapp.com/class2022fall?id="+id,
        dataType: "json",
